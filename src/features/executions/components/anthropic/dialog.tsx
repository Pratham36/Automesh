...
const formSchema = z.object({
  ...
  model: z.enum(AVAILABLE_ANTHROPIC),
...
export const AnthropicDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defaultValues.model || AVAILABLE_ANTHROPIC[0],
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Configure setting for Anthropic</DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select the model to use for the Anthropic node.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
