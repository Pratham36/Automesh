...
import { Execution, ExecutionStatus } from "@/generated/prisma"; // Fixed import type from Workflow to Credential
import {
  CheckCircle2Icon,
  ClockIcon,
  Loader2Icon,
...
export const ExecutionsEmpty = () => {
  return (
    <EmptyView message="No executions found. Get by runnung your first workflow" />
  );
};
