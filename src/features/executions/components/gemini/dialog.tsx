...
export const GeminiDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defaultValues.model || AVAILABLE_GEMINI[0],
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Configure setting for Gemini</DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select the model to use for the Gemini node.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
